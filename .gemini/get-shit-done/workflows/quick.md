...
```bash
INIT=$(node "/Users/chaithanyareddy/Desktop/GRIET/draft05/.gemini/get-shit-done/bin/gsd-tools.cjs" init quick "$DESCRIPTION")
...
```bash
node "/Users/chaithanyareddy/Desktop/GRIET/draft05/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
