...
- **Global scope**: `/Users/chaithanyareddy/Desktop/GRIET/draft05/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/chaithanyareddy/Desktop/GRIET/draft05/.claude/notes/`)
...
2. Glob `/Users/chaithanyareddy/Desktop/GRIET/draft05/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/chaithanyareddy/Desktop/GRIET/draft05/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/chaithanyareddy/Desktop/GRIET/draft05/.claude/notes/` — works in any directory
